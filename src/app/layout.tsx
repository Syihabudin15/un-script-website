...
export const metadata: Metadata = {
  ...
  keywords: "un-script, un script, uns, jasa pembuatan skripsi, jasa pembuatan tesis, jasa pembuatan tugas akhir, jasa pembuatan website, jasa pembuatan aplikasi mobile, jasa pembuatan undangan digital, jasa pembuatan undangan online, bimbingan skripsi, bimbingan tesis, kelas online, kelas programming, kursus online, kursus online programing, kursus online murah, kursus online murah berkualitas, belajar programming, belajar coding, belajar programming dari dasar, belajar coding pemula, joki, joki tugas, mahasiswa, tugas kuliah"
}
